...
DROP PROCEDURE IF EXISTS cancel_reservation(INT) CASCADE;
...
DROP FUNCTION IF EXISTS issue_permit(INT, INT, DATE, DATE) CASCADE;

-- Drop tables in reverse order of creation
DROP TABLE IF EXISTS sensorEvents CASCADE;
DROP TABLE IF EXISTS tickets CASCADE;
DROP TABLE IF EXISTS violationRates CASCADE;
